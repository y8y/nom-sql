...
pub fn compound_selection(i: &[u8]) -> IResult<&[u8], CompoundSelectStatement> {
  ...
  Ok((remaining_input, CompoundSelectStatement {
    selects,
    order,
    limit,
  }))
  ...
  fn union() {
    ...
    let first_select = SelectStatement {
      ...
      fields: vec![
        ...
        FieldDefinitionExpression::Value(FieldValueExpression::Literal(Literal::Integer(1).into())),
      ],
      ..Default::default()
    };
  ...
  fn multi_union() {
    ...
    let third_select = SelectStatement {
      ...
      fields: vec![
        ...
        FieldDefinitionExpression::Value(FieldValueExpression::Literal(Literal::Integer(5).into())),
      ],
      ..Default::default()
    };
